...
const Section02 = () => {
  return (
    <div className="bg-gray-900 py-16 flex justify-center">
        ...
        <div className="bg-white text-black p-6 rounded shadow-lg w-80 lg:w-auto mt-8 h-[150px]">
                    <p>
                        Jadopte une approche centrée sur lutilisateur, avec une attention particulière aux détails techniques
                        et à la maintenabilité du code. Chaque projet est une opportunité dallier esthétique et performance.
                    </p>
                </div>
                <div className="bg-transparant text-black p-6 rounded shadow-lg w-80 lg:w-auto mt-8 h-[150px]">
      ...
      <div className="relative w-4 flex justify-center mx-9">
        ...
        <div className="bg-transparant text-black p-6 rounded shadow-lg w-80 lg:w-auto mt-8 relative h-[150px]">
